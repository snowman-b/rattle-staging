...
function drawArena() {
  ...
  ctx.beginPath();
  ctx.moveTo(wallLeftX, redPortalStartY);
  ctx.lineTo(wallLeftX, redPortalEndY);
  ctx.stroke();
  ...
  // Left edge
  ctx.beginPath();
  ctx.moveTo(wallLeftX - portalThickness / 2, redPortalStartY);
  ...
  ctx.beginPath();
  ctx.moveTo(wallLeftX - portalThickness / 2, redPortalStartY);
  ctx.lineTo(wallLeftX + portalThickness / 2, redPortalStartY);
  ctx.stroke();
  // Bottom edge
  ctx.beginPath();
